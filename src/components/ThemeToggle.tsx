...
export default function ThemeToggle() {
  ...
  return (
    ...
    >
      <span className="absolute inset-0 rounded-full bg-gradient-to-r from-sky-400/20 via-fuchsia-400/10 to-transparent opacity-0 transition group-hover:opacity-100" />
      <span className="relative flex h-8 w-8 items-center justify-center">
        ...
        <span className="absolute -inset-1 rounded-full bg-gradient-to-r from-sky-400 via-fuchsia-400 to-amber-300 opacity-70 blur-md transition group-hover:opacity-100" />
